...
#twitterStream.filter(track=["quito","Juan Carlos Holguin","#Creo","Maria Sol Corral","#MariaSolCorral","Paco Moncayo ", "#PacoMoncayo", "Carlos Sevilla","#JorgeYunda","Jorge Yunda","#CesarMontufar","Cesar Montufar","#CarlosSevilla","elecciones de alcaldia"])
