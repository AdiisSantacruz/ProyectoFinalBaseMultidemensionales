...
try:
    ...
    db = server.create('manta')
except:
    # Caso contrario solo conectarse a la base existente
    db = server['manta']

# Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(track=["manta","Victor Chiriboga","#VictorChiriboga","Jose Delgado","#JoseDelgado","#AnaMariaSuarezLopez", "#AgustinIntriagoQuijano,", "Agustin Intriago Quijano","Ana Maria Suarez Lopez","elecciones de alcaldia manta"])
twitterStream.filter(locations=[-80.912795,-1.135691,-80.663985,-0.928689])
